...
export const constantRouterMap = [
    ...
    { path: '/authredirect', component: () =>
            import('@/views/login/authredirect'), hidden: true },
    { path: '/404', component: () =>
            import('@/views/errorPage/404'), hidden: true },
    { path: '/401', component: () =>
            import('@/views/errorPage/401'), hidden: true },
    {
        path: '',
        component: Layout,
        redirect: 'dashboard',
...
export const asyncRouterMap = [
    ...
    // },
    {
        ...
        children: [{
            path: 'index',
            component: () => import('@/views/alibabaSpider/index'),
            name: 'alibabaSpider',
            meta: {
                title: '一键扒图',
                icon: 'icon',
